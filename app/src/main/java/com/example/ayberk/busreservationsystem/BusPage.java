...
public class BusPage extends Activity {
    ...
    List<String> originValues=Arrays.asList("Istanbul","Ankara", "Bolu", "Izmir", "Kocaeli", "Eskişehir", "Nevşehir", "Antalya","Muğla","Gaziantep","Çanakkale","Adana");
    List<String> destinationValues=Arrays.asList("Istanbul","Ankara", "Bolu", "Izmir", "Kocaeli", "Eskişehir", "Nevşehir", "Antalya","Muğla","Gaziantep","Çanakkale","Adana");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter2.addAll(destinationValues);
        destination.setAdapter(adapter2);
        destination.setSelection(adapter2.getCount());
        destination.setPrompt("please select a destination");
